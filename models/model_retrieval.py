...
class XVLM(XVLMBase):
    ...
    def forward(self, image, text_ids, text_atts, text_atts_mask=None, text_ids_masked=None, masked_pos=None, masked_ids=None, 
                idx=None, single_text_embed=None, mpr_ids=None):
        ...
        loss_itm, loss_text_KD = self.get_matching_loss(image_embeds, image_atts, image_feat, text_embeds, text_atts, 
                                                        text_feat, idx=idx, single_text_embed = single_text_embed)
        ...
        return loss_itc, loss_itm, loss_text_KD*1300, loss_mlm*0.4, loss_mpr*0.0